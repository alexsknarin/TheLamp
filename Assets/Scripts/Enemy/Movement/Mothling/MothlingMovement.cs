...
public class MothlingMovement : EnemyMovement
{
    ...
    private MothlingMovementAttackState _attackState;
    private MothlingMovementPreAttackState _preAttackState;    
    ...
    public override void Initialize()
    {
        ...
        _preAttackState = new MothlingMovementPreAttackState(this, _speed, _radius, _verticalAmplitude);
        _attackState = new MothlingMovementAttackState(this, _speed, _radius, _verticalAmplitude);
    ...
    private void Update()
    {
        ...
        if (_isNoiseEnabled)  
        {
            ...
            if (_currentState.State == EnemyStates.Attack)
            {
                ...
                if (_position2d.magnitude < 0.86f)
                {
