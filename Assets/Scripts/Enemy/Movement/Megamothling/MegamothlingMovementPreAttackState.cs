...
public class MegamothlingMovementPreAttackState: EnemyMovementBaseState
{
    ...
    public MegamothlingMovementPreAttackState(IStateMachineOwner owner, float speed, float radius, float verticalAmplitude) : base()
    {
        _speed = speed;
        _radius = radius;
    ...
    {
        Position = currentPosition + currentPosition.normalized * (_speed * _acceleratedSpeed * Time.deltaTime);
