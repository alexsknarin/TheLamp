...
public class FSpiderMovementClimbUpState: RegularEnemyMovementStateBase
{
    ...
    public FSpiderMovementClimbUpState(IPositionDirectionProvider positionDirectionProvider, float xCenter, float height)
    {
