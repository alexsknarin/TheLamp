...
{
    [CreateAssetMenu(fileName = "FDragonflyAttackTailFailStateR", menuName = "FDragonflyMovementStates/FDragonflyAttackTailFailStateR")]
    public class FDragonflyAttackTailFailStateR : ScriptableObject, IState, IRight
    {
