...
{
    [CreateAssetMenu(fileName = "FDragonflySpiderPatrolStateR", menuName = "FDragonflyMovementStates/FDragonflySpiderPatrolStateR")]
    public class FDragonflySpiderPatrolStateR : ScriptableObject, IState, IRight
    {
