...
{
    [CreateAssetMenu(fileName = "FDragonflyDeathTailStateR", menuName = "FDragonflyMovementStates/FDragonflyDeathTailStateR")]
    public class FDragonflyDeathTailStateR : ScriptableObject, IState, IRight
    {
