...
{
    [CreateAssetMenu(fileName = "FDragonflyPreAttackTailStateR", menuName = "FDragonflyMovementStates/FDragonflyPreAttackTailStateR")]
    public class FDragonflyPreAttackTailStateR : ScriptableObject, IState, IRight
    {
