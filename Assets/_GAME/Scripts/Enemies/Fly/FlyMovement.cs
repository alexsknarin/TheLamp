...
namespace _GAME.Scripts.Enemies.Fly
{
    public class FlyMovement : EnemyMovementBase, IPositionDirectionProvider, ISpreadableMovement
    {
        ...
        private FlyGenericMovementAcceleratedAttackState _attackState;
        ...
        public override void Initialize()
        {
            ...
            _attackState = (FlyGenericMovementAcceleratedAttackState)_stateFactory.Create(typeof(FlyGenericMovementAcceleratedAttackState));
